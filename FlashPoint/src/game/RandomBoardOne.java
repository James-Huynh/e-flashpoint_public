...
public class RandomBoardOne extends TemplateGame{
...
//	private String subLevel; //Recruit, Heroic or Veteran
	...
	public RandomBoardOne(String difficulty) { //Constructor for Family since it will not have subLevel
	...
	public void setEdgeLocations() {
		...
		edgeLocations[1][2] = 2;
		edgeLocations[6][18] = 2;
		
		// 4 closed door location
		edgeLocations[4][6] = 2;
		edgeLocations[3][5] = 2;
		edgeLocations[3][14] = 2;
		edgeLocations[6][5] = 2;
