...
public class RandomBoardFive extends TemplateGame{
...
//	private String subLevel; //Recruit, Heroic or Veteran
	...
	public RandomBoardFive(String difficulty) { //Constructor for Family since it will not have subLevel
	...
	public void setEdgeLocations() {
		...
		edgeLocations[5][5] = 1;
		edgeLocations[5][7] = 1;
		edgeLocations[6][12] = 1;
		edgeLocations[5][12] = 1;
		edgeLocations[1][8] = 1;
		edgeLocations[2][8] = 1;
		edgeLocations[3][13] = 1;
		edgeLocations[3][15] = 1;
		edgeLocations[3][17] = 1;
		edgeLocations[3][9] = 1;
		edgeLocations[3][12] = 1;
		...
		edgeLocations[1][5] = 2;
		edgeLocations[7][15] = 2;
		edgeLocations[4][18] = 2;
		
		// 8 closed door location
		edgeLocations[3][8] = 2;
		edgeLocations[3][10] = 2;
		edgeLocations[3][11] = 2;
		edgeLocations[4][9] = 2;
		edgeLocations[4][10] = 2;
		edgeLocations[4][11] = 2;
		edgeLocations[4][12] = 2;
		edgeLocations[5][9] = 2;
